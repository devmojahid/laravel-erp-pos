<div class="header-cart-wrap rev-5-header-cart-wrap" id="headerCartWrap">
    <div class="cart-list">
        <div class="title">
            <h3>Shopping Cart</h3>
        ...
        <ul>
            <li>
                <a href="shop-details.html">
                    <div class="part-img">
                        <img src="{{ asset('frontend') }}/assets/images/feat-product-3.jpg" alt="Image">
                    </div>
                    <div class="part-txt">
            ...
            <li>
                <a href="shop-details.html">
                    <div class="part-img">
                        <img src="{{ asset('frontend') }}/assets/images/feat-product-2.jpg" alt="Image">
                    </div>
                    <div class="part-txt">
            ...
            <li>
                <a href="shop-details.html">
                    <div class="part-img">
                        <img src="{{ asset('frontend') }}/assets/images/feat-product-10.jpg" alt="Image">
                    </div>
                    <div class="part-txt">

<div class="mobile-menu rev-5-mobile-menu d-lg-none d-block">
                ...
                <div class="category-sub-menu">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-4">
                            ...
                            <a href="#">
                                <img src="{{ asset('frontend') }}/assets/images/mega-menu-bg-2.jpg" alt="Image">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="category-sub-menu">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-12">
                            <h4><span><i class="flaticon-season"></i></span> Season Sale</h4>
                            <a href="#">
                                <img src="{{ asset('frontend') }}/assets/images/mega-menu-bg-3.jpg" alt="Image">
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div class="m-main-menu">
        ...
        <ul class="menu-bar">
            <li class="logo">
                <img src="{{ asset('frontend') }}/assets/images/logos/logo-5.png" alt="Logo">
            </li>
            <li class="nav-item">
                <a class="nav-link" href="index-5.html">Home</a>
            </li>
            <li class="nav-item">
    ...
    <ul class="mobile-nav">
        ...
        <li><a role="button" data-target="m-main-menu" class="m-nav-link"><i
                    class="fa-light fa-ellipsis-stroke"></i></a></li>
    </ul>
</div>
